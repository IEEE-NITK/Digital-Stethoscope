...
Original file is located at
    https://colab.research.google.com/drive/1GvTZGFrDc8m0X7hDt_9PugQ_jBQXSTxf
"""
...
model = Sequential()
model.add(LSTM(units=256, dropout=0.20, recurrent_dropout=0.10, return_sequences=True,input_shape = (40,1)))
model.add(LSTM(units=128, dropout=0.20, recurrent_dropout=0.10, return_sequences=True))
#model.add(LSTM(units=64, activation = 'tanh', dropout=0.20, recurrent_dropout=0.10, return_sequences=True))
